...
import { MeteoFeatureCurrentWeatherBaseModule } from "./platform-web-meteo-feature-current-weather.base";
...
export class PlatformWebMeteoFeatureCurrentWeatherElementModule implements DoBootstrap {
